...
public interface VFileService {
    ...
    VFileDTO query(Long vFileId, Long userId) throws BusinessException;

    VFileDTO query(Long strategyId, Long parentId, String name) throws BusinessException;
    List<VFileDTO> query(Long userId, Long strategyId, Long parentId, String name) throws BusinessException;
    List<VFileDTO> query(Long userId, String root, Long parentId, String name) throws BusinessException;
    ...
    List<VFileDTO> queryBatch(Long userId, Long strategyId, Long parentId) throws BusinessException;
    List<VFileDTO> queryBatch(Long userId, String root, Long parentId) throws BusinessException;
    List<VFileDTO> queryBatch(Long userId, String root, Long parentId, Integer page, Integer limit) throws BusinessException;
    Integer queryCount(Long vFileId) throws BusinessException;
    Boolean isExist(Long vFileId) throws BusinessException;
    Boolean isExist(Long userId, Long strategyId, Long parentId, String name) throws BusinessException;
    Boolean isExist(Long userId, String root, Long parentId, String name) throws BusinessException;
